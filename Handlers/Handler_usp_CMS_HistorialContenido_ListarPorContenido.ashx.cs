...
namespace CMSBanchileSEGUROS
{
    public class Handler_usp_CMS_HistorialContenido_ListarPorContenido : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            IN_Handler_usp_CMS_HistorialContenido_ListarPorContenido EntradaServicioRest = JsonConvert.DeserializeObject<IN_Handler_usp_CMS_HistorialContenido_ListarPorContenido>(jsonBody);
            //Llamada a metodo
            
            RSP_Handler_usp_CMS_HistorialContenido_ListarPorContenido respuestaServicio = new RSP_Handler_usp_CMS_HistorialContenido_ListarPorContenido();
            try{
            var instancia = new OperacionesBD();
respuestaServicio.Respuesta = instancia.usp_CMS_HistorialContenido_ListarPorContenido(EntradaServicioRest.idContenido);
