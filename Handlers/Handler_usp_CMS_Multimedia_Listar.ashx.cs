...
namespace CMSBanchileSEGUROS
{
    public class Handler_usp_CMS_Multimedia_Listar : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            IN_Handler_usp_CMS_Multimedia_Listar EntradaServicioRest = JsonConvert.DeserializeObject<IN_Handler_usp_CMS_Multimedia_Listar>(jsonBody);
            //Llamada a metodo
            
            RSP_Handler_usp_CMS_Multimedia_Listar respuestaServicio = new RSP_Handler_usp_CMS_Multimedia_Listar();
            try{
...
respuestaServicio.Respuesta = instancia.usp_CMS_Multimedia_Listar();
        ...
        public class IN_Handler_usp_CMS_Multimedia_Listar
        {
