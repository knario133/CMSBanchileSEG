...
namespace CMSBanchileSEGUROS
{
    public class Handler_usp_CMS_Usuario_Crear : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            IN_Handler_usp_CMS_Usuario_Crear EntradaServicioRest = JsonConvert.DeserializeObject<IN_Handler_usp_CMS_Usuario_Crear>(jsonBody);
            //Llamada a metodo
            
            RSP_Handler_usp_CMS_Usuario_Crear respuestaServicio = new RSP_Handler_usp_CMS_Usuario_Crear();
            try{
