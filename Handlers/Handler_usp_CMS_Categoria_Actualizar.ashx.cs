...
namespace CMSBanchileSEGUROS
{
    public class Handler_usp_CMS_Categoria_Actualizar : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            IN_Handler_usp_CMS_Categoria_Actualizar EntradaServicioRest = JsonConvert.DeserializeObject<IN_Handler_usp_CMS_Categoria_Actualizar>(jsonBody);
            //Llamada a metodo
            
            RSP_Handler_usp_CMS_Categoria_Actualizar respuestaServicio = new RSP_Handler_usp_CMS_Categoria_Actualizar();
            try{
