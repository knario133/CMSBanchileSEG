...
namespace CMSBanchileSEGUROS
{
    public class Handler_usp_CMS_ContenidoMultimedia_Asignar : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            IN_Handler_usp_CMS_ContenidoMultimedia_Asignar EntradaServicioRest = JsonConvert.DeserializeObject<IN_Handler_usp_CMS_ContenidoMultimedia_Asignar>(jsonBody);
            //Llamada a metodo
            
            RSP_Handler_usp_CMS_ContenidoMultimedia_Asignar respuestaServicio = new RSP_Handler_usp_CMS_ContenidoMultimedia_Asignar();
            try{
            var instancia = new OperacionesBD();
respuestaServicio.Respuesta = instancia.usp_CMS_ContenidoMultimedia_Asignar(EntradaServicioRest.idContenido, EntradaServicioRest.idArchivo);
